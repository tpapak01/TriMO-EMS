 ...
 */
public class PenaltyComparator implements Comparator {
   ...
   */
  public PenaltyComparator(int nObj) {
    this.nObj = nObj;
    ascendingOrder_ = true;
  } // ObjectiveComparator

  public PenaltyComparator(int nObj, boolean descendingOrder) {
    this.nObj = nObj;
    if (descendingOrder)
  ...
  public int compare(Object o1, Object o2) {
    ...
    double objetive1 = ((Solution) o1).getReimbuPenalty();
    double objetive2 = ((Solution) o2).getReimbuPenalty();
    if (ascendingOrder_) {
