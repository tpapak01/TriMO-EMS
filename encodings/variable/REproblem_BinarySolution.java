...
public class REproblem_BinarySolution extends BinarySolutionType {

    public REproblem_BinarySolution(Problem problem) {
        super(problem);
    }    
    
    @Override
    public Variable[] createVariables() {
		REproblem problem = (REproblem) this.problem_;
